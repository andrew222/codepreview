    ...
    protected final Dialog createDialog( int id ) {
        try {
            ...
            case INFO_DIALOG: {
                    ...
                    String highlighted = highlighter.highlight("java", "LayoutInflater factory = LayoutInflater.from(owner);");
                    ((TextView) tvs.findViewById(R.id.text_view)).setText(Html.fromHtml(highlighted));
                    if( tvs != null ) {
